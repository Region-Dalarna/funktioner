...
# Här börjar postgis funktionen
 ...
 hamta_karttabell <- function(){
   ...
   karttabell_df <- karttabell_df %>%  
     ...
     add_row(namn = "tatorter", id_kol = "tatortskod", lankol = "lnkod", kommunkol = "kommunkod", sokord = list(c("tatort", "tätort", "tatorter", "tätorter", "tatortspolygoner", "tätortspolygoner"))) %>% 
     add_row(namn = "tatortspunkter", id_kol = "tatortskod", lankol = "lnkod", kommunkol = "kommunkod", sokord = list(c("tatortspunkter", "tätortspunkter"))) %>% 
