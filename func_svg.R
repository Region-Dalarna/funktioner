...
svg_indatafil <- paste0(svg_mapp, "Dalarna_skal4_kon_aug_2024.svg")
...
svg_inlast <- svg_koppla_ihop_grupper(svg_indatafil)
...
meta_df <- svg_meta_df_skapa(svg_inlast)


# 3. Ta bort de tre största cirklarna som vi inte vill ha kvar ============================================================

# Ta bort cirklarna för root, skala och data
svg_lista <- svg_element_ta_bort_med_namn(svg_lista = svg_inlast,
                                          meta = meta_df,
                                          namn = c("root", "skala", "data"))

# 4. Flytta på cirklarna i gruppen "skala" ==============================================================================

svg_lista_ny <- svg_lista_korrekt

test <- svg_skala_cirklar_ordna(svg_lista)

# 6. Skapa en ny SVG-fil med de uppdaterade positionerna ===============================================================


output_file <- paste0(svg_mapp, "Dalarna_skal4_kon_aug_2024_klar.svg")
